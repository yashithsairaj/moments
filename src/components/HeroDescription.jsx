    ...
    <div className="py-10 px-4">
      <div className="max-w-7xl mx-auto">
        <div className=" rounded-3xl p-10 md:p-16">
          ...
          <p className="text-lg md:text-3xl font-roboto text-center" data-aos="fade-up" data-aos-duration="1000">
            Moments is a smart event photography platform that helps you easily
            access, organize, and share your special event photos.
          </p>
          <br />
          <p className="text-lg md:text-3xl font-roboto text-center pt-7" data-aos="fade-up" data-aos-duration="1500">
